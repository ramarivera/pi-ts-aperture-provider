...
function preferredProviderIds(model: ApertureModel, index: ModelsDevIndex): string[] {
...
function normalizeModelKeys(model: ApertureModel): string[] {
...
function insertMultiValue(
	map: Map<string, IndexedModelsDevModel[]>,
	key: string,
	value: IndexedModelsDevModel
) {
...
function findProviderScopedMatch(
	model: ApertureModel,
...
export function enrichApertureModelMetadata(
	model: ApertureModel,
